/** Personal name — use in hero, footer, metadata author, Person schema. */
export const PERSON_NAME = "Sundar Lingam";
...
export const CONTACT_PHONE = "+916382519651";

export const PAGE_TITLE = `${PERSON_NAME} | ${JOB_TITLE}`;
