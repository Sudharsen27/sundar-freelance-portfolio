...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `${PERSON_NAME} — ${JOB_TITLE} at ${BRAND_NAME}. Modern websites, landing pages, and full-stack web apps for brands and startups.`,
  ...
  twitter: {
    ...
    description: `${PERSON_NAME} — ${JOB_TITLE}. Modern websites, landing pages, and full-stack web apps for brands and startups.`,
  },
};
